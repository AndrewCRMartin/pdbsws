...
ValidateAC();
print "INFO: *** MARKING SWISSPROT ENTRIES FROM PDB AS DONE ***\n";
MarkSProtEntries();
print "INFO: *** TRANSFERRING SINGLE CHAIN ENTRIES FROM SWISSPROT ***\n";
TransferFromSprot();
print "INFO: *** REMOVING ERROR ENTRIES ***\n";
RemoveErrors();
print "INFO: *** REMOVING FALSE CHIMERAS - MULTIPLE DBREFs IN PDB FOR ONE AC ***\n";
DeleteFalseChimeras();
